...
const theme = createTheme({
  ...
  typography: {
    ...
    h1: {
      ...
      [defaultTheme.breakpoints.down('lg')]: { fontSize: '5.4rem', lineHeight: '5.6rem' },
      [defaultTheme.breakpoints.down('md')]: { fontSize: '4.4rem', lineHeight: '4.6rem' },
      [defaultTheme.breakpoints.down('sm')]: { fontSize: '3.4rem', lineHeight: '4rem' },
    },
    h2: {
      color: grey[100],
      fontSize: '5rem',
      ...
      textTransform: 'uppercase',
      fontWeight: 700,
      [defaultTheme.breakpoints.down('lg')]: { fontSize: '4.4rem', lineHeight: '4.6rem' },
      [defaultTheme.breakpoints.down('md')]: { fontSize: '3.4rem', lineHeight: '3.6rem' },
      [defaultTheme.breakpoints.down('sm')]: { fontSize: '2.4rem', lineHeight: '2rem' },
    },
    h3: {
      color: grey[100],
      fontSize: '3rem',
